...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Motorcycle App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Motorcycle App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Motorcycle App Login', user : req.user }); 
}); 
